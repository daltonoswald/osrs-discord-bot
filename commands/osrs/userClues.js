...
module.exports = {
    ...
    .setName('clues-hs')
    .setDescription('Searches a user\'s clue score on the hiscores')
    ...
    async execute(interaction) {
        ...
        for (const [clue, values] of Object.entries(hiscoreData.clues)) {
            ...
            userEmbed.addFields(
                ...
                { name: clue, value: `${bold('score')}: ${values.score.toString()} ${bold('rank')}: ${values.rank.toString()}`, inline: true },
            );
        }
