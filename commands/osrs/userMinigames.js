...
module.exports = {
    ...
    .setName('minigames-hs')
    .setDescription('Searches a user\'s minigame scores on the hiscores')
    ...
    async execute(interaction) {
        ...
        for (const [minigame, values] of Object.entries(hiscoreData.minigames)) {
            ...
            userEmbed.addFields(
                ...
                { name: minigame, value: `${bold('score')}: ${values.score.toString()} ${bold('rank')}: ${values.rank.toString()}`, inline: true },
            );
        }
